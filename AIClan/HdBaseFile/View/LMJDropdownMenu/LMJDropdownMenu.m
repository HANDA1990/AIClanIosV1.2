...
- (void)createMainBtnWithFrame:(CGRect)frame{
    ...
    _mainBtn.layer.cornerRadius = 4.0;
    _mainBtn.layer.borderColor  = NavColor.CGColor;
    _mainBtn.layer.borderWidth  = 1;
    
    _mainBtn.layer.shadowColor = NavColor.CGColor;//阴影颜色
    _mainBtn.layer.shadowOffset = CGSizeMake(0, 0);//偏移距离
    _mainBtn.layer.shadowOpacity = 0.5;//不透明度
    _mainBtn.layer.shadowRadius = 3.0;//半径
...
- (void)setMenuTitles:(NSArray *)titlesArr rowHeight:(CGFloat)rowHeight{
    ...
    _listView.layer.shadowColor = NavColor.CGColor;//阴影颜色
    _listView.layer.shadowOffset = CGSizeMake(0, 0);//偏移距离
    _listView.layer.shadowOpacity = 0.5;//不透明度
    _listView.layer.shadowRadius = 3.0;//半径
