...
- (void)setupViews{
    ...
    [self setupButton:_decreaseBtn normalImage:@"decrease2@2x" HighlightImage:@"decrease@2x"];
    [self addSubview:_decreaseBtn];
    
    _increaseBtn = [[UIButton alloc] init];
    [self setupButton:_increaseBtn normalImage:@"increase2@2x" HighlightImage:@"increase@2x"];
...
- (void)setupButton:(UIButton *)btn normalImage:(NSString *)norImage HighlightImage:(NSString *)highImage{
    [btn setBackgroundColor:XXColor(198, 46, 0, 1)];
