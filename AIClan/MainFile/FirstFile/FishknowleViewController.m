...
@interface FishknowleViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation FishknowleViewController
...
- (void)clickReloads{
    [SVProgressHUD show];
    [AppRequest Request_Normalpost:@"ylzs" json:@{@"title":searchTxt.text ? searchTxt.text : @"",@"page":@"1",@"page_size":@"50"} controller:self completion:^(id result, NSInteger statues) {
        if (statues == 1) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell) {
        ...
        UILabel *infoLab2 = [[UILabel alloc] initWithFrame:CGRectMake(20, titleLab.bottom, self.view.width - 20, 30)];
        infoLab2.tag = 1002;
