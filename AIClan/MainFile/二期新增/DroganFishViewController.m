//
//  DroganFishViewController.m
//  AIClan
//
//  Created by hd on 2019/5/19.
...
@interface DroganFishViewController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation DroganFishViewController
...
{
    return  indexPath.section == 0 ? 465:155;
}
...
//        if (indexPath.section == 0 && indexPath.row == 0) {
            UIView *headBgV = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.width, 465)];
            headBgV.tag = 100;
            ...
            [icornImgV setImage:[UIImage imageNamed:@"龙鱼品牌头像"]];
            ...
            //添加中间按钮
            [self addBtnView:4 bgv:headBgV orginY:infoBv.bottom + 15];
//        }
        ...
        UIImageView *icornImgV2 = [[UIImageView alloc] initWithFrame:CGRectMake(20, 10, 30, 30)];
        icornImgV2.tag = 102;
        [icornImgV2 setImage:[UIImage imageNamed:@"龙鱼品牌头像"]];
        ...
        [detailLab setFont:[UIFont fontWithName:@"STXinwei" size:10.0]];
...
//
//                                  value:[UIFont fontWithName:@"STXinwei" size:6]
//
//                                  range:NSMakeRange(0 , [Lab4.text length])];
//
...
- (void)addBtnView:(int)Num bgv:(UIView *)bgv orginY:(float)orginY
{
    for (int k = 0; k < 4; k ++) {
        UIButton *addBtn = [[UIButton alloc] init];
        addBtn.frame = CGRectMake(30, orginY, 120, 25);
        addBtn.tag = 500+k;
        if (k==0) {
            addBtn.x = 30;
            addBtn.y = orginY;
            ...
            addBtn.x = 30;
            addBtn.y = orginY + 40;
            [addBtn setTitle:@"芯片查询  >" forState: UIControlStateNormal];
        }
        else if (k == 3){
            addBtn.x = bgv.width - 160;
            addBtn.y = orginY + 40;
            [addBtn setTitle:@"网店查询  >" forState: UIControlStateNormal];
        }
        ...
        [addBtn setTitleColor:[UIColor darkGrayColor] forState:UIControlStateNormal];
        addBtn.titleLabel.font = [UIFont fontWithName:@"STXinwei" size: 16];
